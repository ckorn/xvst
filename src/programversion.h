...
static const QString PROGRAM_VERSION		= "1.7 Alpha"; 	//<! Current program version
static const QString PROGRAM_VERSION_SHORT	= "1.7a"; 		//<! Current program version (short version)
