...
static const QString PROGRAM_VERSION		= "2.1.1"; 	//!< Current program version
static const QString PROGRAM_VERSION_SHORT	= "2.1.1";	//!< Current program version (short version)
