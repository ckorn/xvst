...
static const QString PROGRAM_VERSION		= "1.6.1 Alpha"; 	//<! Current program version
static const QString PROGRAM_VERSION_SHORT	= "1.6.1a"; 		//<! Current program version (short version)
