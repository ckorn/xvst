...
static const QString PROGRAM_VERSION		= "1.4 Beta"; 	//<! Current program version
static const QString PROGRAM_VERSION_SHORT	= "1.4b"; 		//<! Current program version (short version)
#ifdef Q_OS_WIN32
