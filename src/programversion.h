...
static const QString PROGRAM_VERSION		= "2.3.3"; 	//!< Current program version
static const QString PROGRAM_VERSION_SHORT	= "2.3.3";	//!< Current program version (short version)
