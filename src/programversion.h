...
static const QString PROGRAM_VERSION		= "1.7.1 Alpha"; 	//<! Current program version
static const QString PROGRAM_VERSION_SHORT	= "1.7.1a"; 		//<! Current program version (short version)
