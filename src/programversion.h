...
static const QString PROGRAM_VERSION		= "1.8.3 Alpha"; 	//<! Current program version
static const QString PROGRAM_VERSION_SHORT	= "1.8.3a"; 		//<! Current program version (short version)
