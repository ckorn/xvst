...
static const QString PROGRAM_VERSION		= "1.8.1 Alpha"; 	//<! Current program version
static const QString PROGRAM_VERSION_SHORT	= "1.8.1a"; 		//<! Current program version (short version)
