...
static const QString PROGRAM_VERSION		= "2.4.1"; 	//!< Current program version
static const QString PROGRAM_VERSION_SHORT	= "2.4.1";	//!< Current program version (short version)
static const int	 PROGRAM_VERSION_NUMBER	= 241;		//!< Current program version (numeric version)
