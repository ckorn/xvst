...
static const QString PROGRAM_VERSION		= "2.0.1 Alpha"; 	//<! Current program version
static const QString PROGRAM_VERSION_SHORT	= "2.0.1a"; 		//<! Current program version (short version)
